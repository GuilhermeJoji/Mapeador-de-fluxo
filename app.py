...
def gerar_bpmn_com_lanes(passos):
    ...
    for nome, eid in element_ids.items():
        ...
        ET.SubElement(plane, "bpmndi:BPMNShape", {
            "id": f"{eid}_di",
            "bpmnElement": eid
        }).append(ET.Element("dc:Bounds", {
...
# Streamlit UI
st.title("🧠 Mapeador de Fluxo BPMN")
uploaded_file = st.file_uploader("Faça upload do arquivo .txt com o processo")
...
if uploaded_file:
    ...
    st.success("✅ Diagrama BPMN gerado!")
